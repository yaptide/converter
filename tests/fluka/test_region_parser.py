...
def test_parse_regions(zones_json, project_fluka_json):
    ...
    assert regions[0].figures_operators == [
        [(BoolOperation.INTERSECTION, "fig0"), (BoolOperation.SUBTRACTION, "fig1"), (BoolOperation.SUBTRACTION, "fig2")]
    ]
    ...
    assert regions[4].figures_operators == [
        [
            (BoolOperation.INTERSECTION, "figworld"),
            (BoolOperation.SUBTRACTION, "fig0"),
            (BoolOperation.SUBTRACTION, "fig1"),
            (BoolOperation.SUBTRACTION, "fig2"),
            (BoolOperation.SUBTRACTION, "fig3"),
            (BoolOperation.SUBTRACTION, "fig4"),
        ]
    ]

    assert regions[5].name == "boundary"
    assert regions[5].figures_operators == [
        [(BoolOperation.INTERSECTION, "figbound"), (BoolOperation.SUBTRACTION, "figworld")]
    ]
