...
* cylinder 
* bottom center (+0.0, +10.0, +10.0), top center (+0.0, -10.0, +10.0),
* spanning vector (+0.0, -20.0, +0.0),
* radius +10.0, height +20.0 cm
* rotation angles: 90.0*, 0.0*, 0.0*
  RCC    1       0.0      10.0      10.0       0.0     -20.0       0.0
                10.0
* cylinder 
* bottom center (+0.0, +12.5, +7.5), top center (+0.0, -12.5, +7.5),
* spanning vector (+0.0, -25.0, +0.0),
* radius +15.0, height +25.0 cm
* rotation angles: 90.0*, 0.0*, 0.0*
  RCC    2       0.0      12.5       7.5       0.0     -25.0       0.0
                15.0
* cylinder 
* bottom center (+0.0, +15.0, +5.0), top center (+0.0, -15.0, +5.0),
* spanning vector (+0.0, -30.0, +0.0),
